...
router.get('/api/v1/users', tokenVeryfiy, getUser);
...
router.patch('/api/v1/profile-upate', tokenVeryfiy, updateUser);
router.get('/api/v1/user/:id', tokenVeryfiy, getSingleUser);
